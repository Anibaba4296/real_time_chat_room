...
<body>
  <p><marquee style="color: white;font-size:20px;">Aniket Kumar | Roll Number : 1 | Section : K20WY</marquee></p>
  <h1>ChatRoom</h1>
  <div class="login">
    <h2>Login</h2>
    <p>This is a PHP project Made for CA-3 by Aniket Kumar of section K20WY holding roll number 1</p>
